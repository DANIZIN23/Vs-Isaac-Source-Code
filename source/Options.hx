...
class IsaacOption extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.oldisaac = !FlxG.save.data.oldisaac;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.oldisaac ? "Use old Isaac Sprites" : "Use new Isaac Sprites";
	}
}
